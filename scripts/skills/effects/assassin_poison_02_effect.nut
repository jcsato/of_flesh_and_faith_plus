assassin_poison_02_effect <- inherit("scripts/skills/skill", {
	...
	function getTooltip() {
		...
		local ret = [
			...
			{ id = 11, type = "text", icon = "ui/icons/fatigue.png", text = "Every weapon attack that " + thresholdString + " applies a poison that reduces the target's Resolve by [color=" + Const.UI.Color.NegativeValue + "]5[/color] for 2 turns" }
