ironhand_dream_04_event <- inherit("scripts/events/event",
{
	...
	function create()
	{
		...
		m.Screens.push({
							ID			= "A"
							Text		= "[img]gfx/ui/events/event_39.png[/img]{As the company settles around the campfire, a sudden weariness falls upon you. You make your way to your tent, but on the way you bump into %chosen%. He's got something in his hands you can't see.%SPEECH_ON%Oh, captain, there you are. I wanted to show you this. It's the darndest thing.%SPEECH_OFF%He hands you what looks like some kind of black rock, and the instant you touch it the whole world falls away. You find yourself in a scorched wasteland, bits of charred grass and dead trees breaking up the otherwise featureless hills. In front you wanders a herd not of sheep but of gray, dying wolves, led by a cloaked shepherd tossing out seeds on the ground. You confront him.%SPEECH_ON%What a farce. This is why Ironhand's will must be fulfilled. Look at you, sowing a barren land, herding predators instead of livestock. This is not a world in which one peacefully farms to sustain themselves. Take up arms! Slay the wolf and take its meat! Give meaning to your struggle, give it death and purpose!%SPEECH_OFF%As you speak, you see the shepherd's bearded face begin to squirm and morph, and he turns to you and you see a face you recognize for a moment but then his mouth opens and keeps opening and the maw consumes him whole and underneath the hood you can now see nothing but teeth, teeth affixed in an evil smile that is reflected by the teeth in the starless, empty void of the sky, and the shepherd's staff twists and warps and turns and an axehead forms out of it and the cackling fills your ears and the wolves have the faces of men and you stare at one and it is your face.%SPEECH_ON%Death and purpose indeed, 'mine chosen'. I await thee.%SPEECH_OFF%The cackling grows louder, piercing you, and you double over in pain, and you are back in camp with %chosen% and the black rock is gone.%SPEECH_ON%Captain, are you alright? I feel like I just...saw something.%SPEECH_OFF%You remember nothing. You were feeling tired and headed to your tent, but the fatigue is gone, replaced only with an empty, gnawing doubt. The rest of the men feel it too, but none can put a finger on why. Something just feels...wrong.}"
							Image		= ""
							List		= [ ]
							Characters	= [ ]
							Options		= [
