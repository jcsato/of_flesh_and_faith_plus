::mods_queue("of_flesh_and_faith_plus", "", function() {
	::mods_hookNewObject("events/events/dlc2/location/fountain_of_youth_event", function(foye) {
		...
		foye.m.Screens.push({
								...
								function start(_event)
								{
									...
									foreach( bro in brothers ) {
										...
										bro.getSkills().removeByID("rot_01");
										bro.getSkills().removeByID("rot_02");
										bro.getSkills().removeByID("rot_03");
										bro.getSkills().removeByID("rot_04");
										bro.getSkills().removeByID("rot_05");
									}
								}
							});
		...
		foye.onDetermineStartScreen = function() {
			if (World.Assets.getOrigin().getID() != "scenario.explorers")
				...
				foreach( bro in brothers ) {
					totalRot += bro.getFlags().getAsInt("CursedExplorersRotsActive");
				}
	...
	::mods_hookNewObject("events/events/dlc6/location/oracle_enter_event", function(oee) {
		...
		oee.m.Screens.push({
							...
							Text		= "[img]gfx/ui/events/event_167.png[/img]{An eclectic group of armed men stands before you, obviously mercenaries. Many are northerners, but you see a few southerners in the ranks as well - and there, in the shadows, robed men invisible to the untrained eye. It seems some of the guilds' previously failed attempts were subverted, not just thwarted.\n\nOn a small dais in the center of them all sits an imposing man, clad head to toe in black and gold armor. You take it this is the Prophet. He motions for you to sit on a nearby seat and speaks in a deep voice.%SPEECH_ON%Welcome, Crownlings. Firi has told me much of your exploits. It is good that you have come, for I have need of men like you. The Gilder himself has given me visions of a great evil brewing in the mountains, an evil of flesh and...of stone.%SPEECH_OFF%He pauses and motions with his arm toward a cluster of statues. Each has been defaced, left with raw, chipped stone where artisans' features used to rest. Seeing your quizzical look, the Prophet continues.%SPEECH_ON%I'm sure you have many questions, but before we discuss further how you can help me, let us discuss how I can help you. You are something of a curiosity to me, I admit. I understand the mind of a Crownling - it is motivated by the Gilder's coin, and rightly so, for what is a life that lacks that most important of his many gleams? I understand also the mind of an Assassin - it is motivated by faith and the promises of paradise, and even if the promise is empty coming from that wretched old man, it is nonetheless a promise that I can make good on. But you...you are both. What drives you, oh castaway of the guilds? Is it loyalty to a man that exiled you and sent you here to die? Is it the crowns you make selling your skills for the amusement of others?%SPEECH_OFF%You calmly rise to your feet, unfazed that the man knows who - what - you are, nor by his guards as they draw their weapons. For a moment, you see not the Prophet, but an elderly, bearded man you recognize from...somewhere, now smiling, now grimacing, now stern and sightless in the face of the fiery death. Then it's gone, and before you once more is the pretender in his golden armor, surrounded by his little guards. You scoff.%SPEECH_ON%Is the Gilder so sightless that his own prophet cannot see into the shadows of his gleam? Or is this just the extent of one who sees himself a ruler in the reflection of his coins? There's only one thing you can offer me, and that's your head. No need to give it here, I'll come take it myself.%SPEECH_OFF%}"
							Image		= ""
							List		= [ ]
							Characters	= [ ]
							Options		= [
